...
import macrosCode from '../examples/basics/macros.c?raw';
...
import pointersCode from '../examples/advanced/pointers.c?raw';
import stringsCode from '../examples/advanced/strings.c?raw';
import mathCode from '../examples/advanced/math.c?raw';
import memoryCode from '../examples/advanced/memory.c?raw';
